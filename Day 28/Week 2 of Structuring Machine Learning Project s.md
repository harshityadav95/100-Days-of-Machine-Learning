## Week 2 of Structuring Machine Learning Project s

#### Error analysis  

- Improve performance on blurry images

- Fix great examples being misrecognised

  Create a table on % accuracy image vs classification



### Cleaning up incorrecly labeled data  

- DL algo are robust to error in training set
- keep% of error due to incorrect label
...
- Use bias/variance and analysis error to prioritize next steps
